...
class RatingBarLocal extends StatefulWidget {
  /// Creates [RatingBar] using the [ratingWidget].
  const RatingBarLocal({
    /// Customizes the Rating Bar item with [RatingWidget].
    required RatingWidgetLocal ratingWidget,
  ...
  final RatingWidgetLocal? _ratingWidget;

  @override
  _RatingBarState createState() => _RatingBarState();
}

class _RatingBarState extends State<RatingBarLocal> {
  double _rating = 0.0;
  bool _isRTL = false;
  ...
  @override
  void didUpdateWidget(RatingBarLocal oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    Material(
      ...
      child: Wrap(
        ...
        children:[
          Container(
            width: MediaQuery.sizeOf(context).width*0.257,
            ...
            child: Stack(
              children: [
                PositionedDirectional(
                  ...
                  start: 0,
                  bottom: 0,
                  child:_buildRating(context,0),
                ),
                PositionedDirectional(
                  child: _buildRating(context,1),
                  height: MediaQuery.sizeOf(context).height*0.0186,
                  width:MediaQuery.sizeOf(context).width* 0.0420,
                  start:MediaQuery.sizeOf(context).width* 0.0537 ,
                  bottom:MediaQuery.sizeOf(context).height* 0.0093,
                  // top: 15,
                ),
                PositionedDirectional(
                  child: _buildRating(context,2),
                  height: MediaQuery.sizeOf(context).height*0.0186,
                  width:MediaQuery.sizeOf(context).width* 0.0420,
                  start:MediaQuery.sizeOf(context).width*  0.1074,
                  top: 0,
                ),
                PositionedDirectional(
                  child:_buildRating(context,3),
                  height: MediaQuery.sizeOf(context).height*0.0186,
                  width:MediaQuery.sizeOf(context).width* 0.0420,
                  end: MediaQuery.sizeOf(context).width*  0.0537,
                  bottom: MediaQuery.sizeOf(context).height*0.0093,
                  // top: MediaQuery.sizeOf(context).height*0.0043,
                ),
                PositionedDirectional(
                  child:_buildRating(context,4),
                  height: MediaQuery.sizeOf(context).height*0.0186,
                  width:MediaQuery.sizeOf(context).width* 0.0420,
                  end: 0,
                  bottom:0 ,
  ...
  void _onDragUpdate(DragUpdateDetails dragDetails) {
    if (!widget.tapOnlyMode) {
      ...
      // if (widget.updateOnDrag) widget.onRatingEnd(iconRating);
      setState(() {});
    }
  }

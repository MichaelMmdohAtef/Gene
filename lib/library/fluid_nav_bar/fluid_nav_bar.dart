...
import 'package:Gene/library/fluid_nav_bar/fluid_nav_bar_item.dart';
...
typedef Widget FluidNavBarItemBuilder(FluidNavBarIcon icon, FluidNavBarItemLocal item);
...
///
///
class FluidNavBarLocal extends StatefulWidget {
  static double? nominalHeight;
//56
  ...
  @override
  State createState() => _FluidNavBarLocalState();

  static Widget _identityBuilder(FluidNavBarIcon icon, FluidNavBarItemLocal item) => item;
}

class _FluidNavBarLocalState extends State<FluidNavBarLocal> with TickerProviderStateMixin {
  int _currentIndex = 0;
  ...
  Widget build(context) {
    if(widget.localIndex !=null && widget.localIndex!=_currentIndex)(
        setState(() {
    ...
    FluidNavBarLocal.nominalHeight = MediaQuery.sizeOf(context).height*0.0842;
    double height = FluidNavBarLocal.nominalHeight!;
  ...
  double _indexToPosition(int index) {
    ...
    final startX = ((appWidth - buttonsWidth) / 2);
     if(widget.isArabic){
       return appWidth - (startX + index.toDouble() * buttonsWidth / buttonCount + buttonsWidth / (buttonCount * 2.0));
    }else{
...
class _BackgroundCurvePainter extends CustomPainter {
  ...
  // static const _radiusBottom = 45.0;
  // static const _horizontalControlTop = 0.5;
  // static const _horizontalControlBottom = 0.25;
  // static const _pointControlTop = 0.2;
  // static const _pointControlBottom = 0.25;
  // static const _topY = -30.0;
  // static const _bottomY = 50.0;
  static const _radiusTop = 54.0;
  static const _radiusBottom = 40.0;
  static const _horizontalControlTop = 0.8;
  static const _horizontalControlBottom = 0.25;
  static const _pointControlTop = 0.2;
  static const _pointControlBottom = 0.31;
  static const _topY = -30.0;
  ...
  _BackgroundCurvePainter(double x, double normalizedY, Color color,BuildContext context)
      : _x = x,

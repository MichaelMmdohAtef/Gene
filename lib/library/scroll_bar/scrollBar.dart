...
/// widget in a [ScrollbarLocal] widget.
///
...
///
/// {@tool dartpad}
/// This sample shows a [ScrollbarLocal] that executes a fade animation as scrolling
...
/// that the [ScrollbarLocal] is always visible, since scrolling in the horizontal
...
class ScrollbarLocal extends StatelessWidget {
...
class _MaterialScrollbarState extends RawScrollbarState<_MaterialScrollbar> {
  ...
  MaterialStateProperty<Color> get _thumbColor {
    final Color onSurface = defaultBlueAccentColor;
    ...
    switch (brightness) {
      case Brightness.light:
        ...
        idleColor = _useAndroidScrollbar
            ? defaultBlueDarkColor.withOpacity(0.4)
